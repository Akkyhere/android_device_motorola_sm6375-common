...
persist.vendor.audio.calfile7=/vendor/etc/acdbdata/Speaker_cal.acdb
...
vendor.display.enable_display_extensions=true
...
persist.vendor.radio.mot_efs_log=false
...
debug.sf.high_speed_scroll_factor=0
